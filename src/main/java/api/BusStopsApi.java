...
public class BusStopsApi extends ApiConnector {
    ...
    public BusStop[] getStops() throws JsonProcessingException {
        JSONArray jsonLines = this.get(dataUrl).getJSONObject(CommonDate.getToday()).getJSONArray("stops");
        ObjectMapper mapper = new ObjectMapper();

        return mapper.readValue(jsonLines.toString(), BusStop[].class);
    }
}
